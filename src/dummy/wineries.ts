...
export const wineriesData: WineryInfoType[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    description:
      ...
      '골드럭와인 포트폴리오 중 가장 어린 와인메이커가 만들었지만, 깊은 숙성 뉘앙스를 풍기는 우아한 슈냉블랑 입니다.\n' +
  ...
  },
  {
    ...
    location: 'Germany',
    description:
      '슈나이더 가문의 와이너리는 1465년 라인강 유역 Weil 지역에서 시작되었습니다.\n' +
      ...
      '그들은 자연과 조화를 이루며 건강한 포도밭을 유지하는 것을 철학으로 삼고 있습니다.',
    imagePath: '/domaines/SCHNEIDER.png',
  },
];
